...
function About() {
    ...
    <section className="about-container1">
        ...
        <p>
         <span className="intro-about">Hey there! At the core of my design practice is a desire to help people navigate the digital world with inclusive and data-informed design.</span> <br/> I'm a purposeful UX/UI designer based in Vancouver, BC. With a background in business administration, I developed my design skills through the New Media Design and Web Development program at BCIT.
